...
function area(data) {
    ...
    var format = d3.time.format.iso.parse; // format as above
    ...
    x.domain(
        d3.extent(data.map(function(d) { return format(d.time); })));//Complete the code
    y.domain(
        d3.extent(data.map(function(d) { return parseFloat(d.mag); })));//Complete the code
